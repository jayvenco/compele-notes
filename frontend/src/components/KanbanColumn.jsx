...
export default function KanbanColumn({ boardId, column, onOpenNote, onRename, onRecolor, onDelete, onAddCard }) {
  ...
  return (
    <div className="flex flex-col w-72 shrink-0">
      ...
      <div
        ref={setNodeRef}
        className={`flex-1 min-h-20 rounded-b-xl border ${colColor} p-2 flex flex-col gap-2 transition-colors ${isOver ? 'ring-2 ring-blue-400' : ''}`}
      >
